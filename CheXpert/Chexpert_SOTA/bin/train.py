...
def run_fl(args):
    ...
    for cr in range(comm_rounds):
        ...
        for client in clients:
            ...
            for epoch in range(epoch_start, cfg.local_epoch):
                lr = lr_schedule(cfg.lr, cfg.lr_factor, summary_train['epoch'],
                                cfg.lr_epochs)
                for param_group in optimizer.param_groups:
                    param_group['lr'] = lr
            ...
            bytes_to_upload = sys.getsizeof(model)
            ...
            print("Comm overhead determined")
